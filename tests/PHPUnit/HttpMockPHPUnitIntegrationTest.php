...
class HttpMockPHPUnitIntegrationTest extends AbstractTestCase
{
    ...
    public function testSimpleRequest($path)
    {
        ...
        $this->assertSame($path . ' body', (string)$this->http->client->get($path)->getBody()->getContents());
    ...
    public function testFailedRequest()
    {
        ...
        $this->assertSame('No matching expectation found', (string)$response->getBody()->getContents());
    }
    ...
    public function testMatchQueryString()
    {
        ...
        $this->assertSame(Response::HTTP_NOT_FOUND, $this->http->client->get('/')->getStatusCode());
        $this->assertSame(Response::HTTP_NOT_FOUND, $this->http->client->post('/')->getStatusCode());
    }
